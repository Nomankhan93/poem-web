    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Each project page is designed to show the challenge, POEM's response, location, outcomes, SDG alignment and eventually verified beneficiary data, partners, galleries and reports."
        />
        ...
        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading
              ...
              description="These are initial content placeholders for the new site structure. Replace project descriptions and metrics with POEM's verified project information before public launch."
            />
