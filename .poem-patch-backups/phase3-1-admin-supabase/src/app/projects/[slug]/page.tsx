  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-poem-cream">
          <div className="container-poem py-14">
            <div className="rounded-[30px] border border-black/[0.06] bg-white p-8 md:p-10">
              <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-poem-700">
                Data note
              </p>
              <h2 className="mt-3 text-3xl font-extrabold tracking-[-0.04em] text-poem-950">
                Verified project metrics will be connected here.
              </h2>
              <p className="mt-4 max-w-3xl leading-7 text-poem-muted">
                When the database/admin phase begins, this section can show
                project dates, donor/partner, beneficiary totals, gender and age
                breakdowns, activity progress, reports, image galleries and
                verified results directly from POEM's project records.
              </p>
            </div>
          </div>
        </section>
