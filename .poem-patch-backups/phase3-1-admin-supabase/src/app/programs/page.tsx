        ...
        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading
              ...
              title="Four connected pathways to stronger communities."
              description="These categories provide a clear public structure for POEM's work. As the project database grows, each program can aggregate related projects, results, stories and resources."
            />
